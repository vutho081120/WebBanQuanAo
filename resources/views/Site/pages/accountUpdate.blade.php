...
@section('content')
    <!-- Chen trang tai khoan -->
    <div class="accountUpdate">
        <div class="accountUpdateFrame">
            <!-- Trang tai khoan -->
            <div class="head">
                <h1>  Tài khoản </h1>
            </div>
            <div class="body">
                <section class="h-100 bg-secondary">
                    <form action="{{ route('site.account.update', $nguoidungItem->id) }}" method="POST">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group date" id="datepicker">
                                                            <input type="text" class="form-control" id="date" name="birthday" 
                                                                value="{{ date("d-m-Y", strtotime($nguoidungItem->birthday)) }}">
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12 d-flex justify-content-between">
                                                        <a href="{{ route('site.home.index') }}" class="btn btn-secondary">Quay lại trang chủ</a>
    ...
    <div class="passwordHidden">
        @include('site.components.passwordUpdate');
    </div>
@endsection